      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="mb-3">
          ...
          <div class="">
            ...
            <form class="" action="{{ route('admin.teacher.store') }}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="form-row">
              ...
              <div class="form-row">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <input type="text" class="form-control" name="address" id="address" placeholder="phone" value="" required>
                </div>
              </div>
